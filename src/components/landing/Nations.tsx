...
const nations: Nation[] = [
  ...
  },
  {
    ...
    desc: "Optional finale at TETR College of Business, in the world's fastest-growing business hub. Inside Dubai International Financial Centre (DIFC), family offices, sovereign wealth and the founders building MENA's next wave. The bridge between Asian capital and Western markets.",
