...
const nations: Nation[] = [
  {
    ...
    desc: "Your operating base. Read P&Ls, ship products, run GTM sprints and pitch to founders scaling across India. 4 industry immersions, a visit to Jalandhar factories, and 3 days at partner universities. You leave India having already done the work - not having only studied it.",
  ...
  },
  {
    ...
    desc: "Imperial College London - innovation, deep tech and entrepreneurship at one of the world's top business schools. Decode PE/VC, M&A, luxury brand strategy and the startup pitch playbooks shaping the West through 8 business immersions.",
  ...
  },
  {
    ...
    img: hk,
    title: "Read the East.",
    desc: "Asia's capital gateway. Sessions at CUHK Business School, trading floors at HKEX & HSBC, and a Greater Bay Area sprint into Shenzhen's hardware ecosystem. Learn through business immersions across finance, platforms, logistics and deep tech.",
