      ...
      <div className="container relative">
        ...
        <div className="grid lg:grid-cols-12 gap-4 lg:gap-6">
          ...
          <div ref={panelRef} className="lg:col-span-8 order-1 lg:order-2 scroll-mt-24">
            ...
            <article
              key={n.country}
              className={`col-start-1 row-start-1 relative border border-border bg-background z-30 origin-left transition-[transform,opacity,filter] duration-[22000ms] ease-[cubic-bezier(0.16,1,0.3,1)] ${
            ...
            <article
              className={`col-start-1 row-start-1 border border-border bg-background z-10 transition-[opacity,transform,max-height] duration-[16000ms] ease-out ${
                flipped
