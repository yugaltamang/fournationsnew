...
const Row = () => (
  <div className="flex shrink-0 items-center gap-12 pr-12">
    {items.map((b, i) => (
      <span key={i} className="flex items-center gap-12 font-display text-2xl text-foreground/80 whitespace-nowrap">
        {b}
...
const Marquee = () => (
  <section className="border-y border-border bg-secondary/30 py-6 overflow-hidden">
    <div className="container flex items-center gap-8">
      <span className="shrink-0 font-mono text-xs uppercase tracking-widest text-muted-foreground border-r border-border pr-6">
