...
import immIndiaMfg from "@/assets/immersions/india-manufacturing.webp";
import immIndiaD2C from "@/assets/immersions/india-d2c.webp";
import immIndiaLog from "@/assets/immersions/india-logistics.webp";
import immIndiaBrand from "@/assets/immersions/india-brand.webp";
import immLdnFinance from "@/assets/immersions/london-finance.webp";
import immLdnFintech from "@/assets/immersions/london-fintech.webp";
import immLdnAdvisory from "@/assets/immersions/london-advisory.webp";
import immLdnLuxury from "@/assets/immersions/london-luxury.webp";
import immHkFinance from "@/assets/immersions/hk-finance.webp";
import immHkPlatform from "@/assets/immersions/hk-platform.webp";
...
const londonFaculty: Faculty[] = [
  ...
  { name: "Marc Kitten", designation: "Visiting Professor · Partner, Candesic Strategy Consultants (London & New York)", photo: markPhoto.url },
...
export const terms: Term[] = [
  ...
  /* ── LONDON ── */
  {
    ...
    academic: {
      label: "In Class",
      hero: { chip: "July – August · London · Imperial College London", title: "Term 2 - London", body: "At <strong>Imperial College London</strong>, the second term combines five intensive concentrations: <strong>global capital, competitive strategy, luxury & branding, the experience economy, and leadership</strong>. Delivered at one of the world's top campuses, with a <strong>certificate awarded by Imperial College London</strong>.", img: "https://images.unsplash.com/photo-1541829070764-84a7d30dd3f3?w=800&q=80&fit=crop&crop=center" },
      items: [
...
export const OutclassPhases = ({ phases }: { phases: Phase[] }) => (
  <div className="border border-border bg-secondary/20 p-5 sm:p-7 flex flex-col gap-7">
    {phases.map((p) => (
      <div key={p.code}>
          ...
          {p.drops.map((d, i) => (
            <li key={i} className="flex gap-2.5 text-sm sm:text-base leading-relaxed">
              ...
              <span className="text-foreground/90">
                <span className="font-display text-foreground">{d.title}</span>
