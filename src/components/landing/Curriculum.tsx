...
export const terms: Term[] = [
  /* ── INDIA ── */
  {
    ...
    outclass: {
      label: "Out Class",
      hero: { chip: "Out Class · India", title: "Two Real-World Challenges", body: "Out Class is built around two high-intensity outputs - build a live D2C brand and complete a creators challenge - where you prove the theory by shipping real work.", img: "https://images.unsplash.com/photo-1515187029135-18ee286d815b?w=800&q=80&fit=crop&crop=center" },
      items: [
