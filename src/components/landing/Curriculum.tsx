...
export const terms: Term[] = [
  /* ── INDIA ── */
  {
    ...
    academic: {
      ...
      items: [
        { num: "FIFI", code: "Finance & Fintech", title: "How to read and analyse financial statements?", rows: ["How to read and analyse financial statements?", "How to build financial models & value companies ?"] },
        { num: "SAMA", code: "Sales & Marketing", title: "How to build GTM & pricing strategies that drive growth?", rows: ["How to build GTM & pricing strategies that drive growth?", "How to position your brand using consumer psychology & behavior?", "How to analyse markets & identify new business opportunities?", "How to craft a distinct brand story, voice & identity?", "How to Sell by Solving—Not Just Pitching?"] },
        { num: "MAST", code: "Management & Strategy", title: "How to decode global economic signals & predict business shifts?", rows: ["How to decode global economic signals & predict business shifts?", "How to think strategically about your business?"] },
  ...
  /* ── HONG KONG ── */
  {
    ...
    academic: {
      ...
      items: [
        ...
        { num: "PRDT", code: "Product , AI & Tech", title: "How are China and Hong Kong SAR create complementary for the next wave of AI innovation?", rows: ["How are China and Hong Kong SAR create complementary for the next wave of AI innovation?"] },
